...
graph LR
    subgraph IV ["Biến Độc lập"]
        CSI["Sự Hài lòng"]
        VOL["Khối lượng Thảo luận"]
    end

    subgraph MOD ["Biến Điều tiết"]
        MKT["Cường độ Tiếp thị"]
        CSIxMKT["Tương tác: Hài lòng x Tiếp thị"]
    end

    subgraph DV ["Biến Phụ thuộc"]
        MS["Sức mạnh Thị trường"]
        FP["Tỷ suất Sinh lời"]
    end

    CV["Các biến kiểm soát"]
    ...
    style CSI fill:#ffffff,stroke:#000000,stroke-width:2px
    style VOL fill:#ffffff,stroke:#000000,stroke-width:2px
    style MKT fill:#ffffff,stroke:#000000,stroke-width:2px
    style CSIxMKT fill:#ffffff,stroke:#000000,stroke-dasharray: 5 5,stroke-width:1px
    style MS fill:#ffffff,stroke:#000000,stroke-width:2px
    style FP fill:#ffffff,stroke:#000000,stroke-width:2px
    style CV fill:#ffffff,stroke:#000000,stroke-width:1px
```
