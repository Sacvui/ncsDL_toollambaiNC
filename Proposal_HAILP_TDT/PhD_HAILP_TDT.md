...
Ba lý thuyết sau đây tạo thành khung lý thuyết tích hợp cho đề tài, mỗi lý thuyết giải thích một mắt xích khác nhau trong chuỗi nhân quả từ sự hài lòng đến hiệu quả doanh nghiệp.
...
- *Phía cung (doanh nghiệp):* Các doanh nghiệp FMCG có dữ liệu tài chính công khai và minh bạch tại Việt Nam, tập trung nghiêm ngặt vào các doanh nghiệp niêm yết trên HOSE và HNX để đảm bảo khả năng thu thập dữ liệu thứ cấp chuẩn xác. Danh sách dự kiến bao gồm các công ty B2C thuần túy như: Vinamilk (VNM), Masan Consumer (MCH), Sabeco (SAB), Habeco (BHN), Đường Quảng Ngãi (QNS), Bánh kẹo Hải Châu (HHC), Cholimex Food (CMF), VinaCafé Biên Hòa (VCF), Thực phẩm Bích Chi (BCF), Nước giải khát Chương Dương (SCD), Dầu thực vật Tường An (TAC), Thực phẩm Sao Ta (FMC)... Việc loại bỏ các công ty dạng Holding hoặc chưa niêm yết giúp giảm nhiễu biên lợi nhuận đầu tư tài chính.
...
Khảo sát diện rộng chính thức (n ≥ 500 người tiêu dùng). Đồng thời, thu thập dữ liệu thứ cấp tài chính (BCTC kiểm toán) của 20–30 doanh nghiệp FMCG niêm yết (đồng bộ mốc thời gian với dữ liệu khảo sát và trễ 1 năm để chạy Panel 2SLS). Phân tích PLS-SEM bằng SmartPLS 4: đánh giá mô hình đo lường (reliability, validity) và mô hình cấu trúc (path coefficients, R², f²). Báo cáo chuyên đề tiến sĩ số 1. Viết và nộp bài báo quốc tế Scopus/ISI số 1.
...
**Người hướng dẫn đề xuất 1:** TS. Phùng Minh Tuấn — Khoa Quản trị Kinh doanh, Đại học Tôn Đức Thắng

Lý do đề xuất: TS. Phùng Minh Tuấn có chuyên môn sâu trong lĩnh vực Quản trị Kinh doanh và Marketing chiến lược, phù hợp với hướng nghiên cứu về CSI và hiệu quả doanh nghiệp trong ngành FMCG. Bên cạnh đó, nghiên cứu sinh đã có cơ hội được Thầy hướng dẫn và dẫn dắt trong công tác đào tạo và đam mê nghiên cứu, do đó đã có nền tảng tin tưởng và hiểu biết về phương pháp nghiên cứu định lượng dưới sự định hướng của Thầy. Nếu được thầy trực tiếp hướng dẫn sẽ đảm bảo tính nhất quán trong khung lý thuyết và phương pháp luận của nghiên cứu.

**Người hướng dẫn đề xuất 2 (nếu có):**
PGS. TS. *(Họ tên — đề nghị bổ sung sau khi tham khảo ý kiến của Thầy Phùng Minh Tuấn)*

Chuyên môn mong muốn: Kinh tế lượng ứng dụng, phân tích dữ liệu bảng (panel data), phương pháp biến công cụ (IV/2SLS) — nhằm hỗ trợ phần phân tích tích hợp dữ liệu đa cấp giữa khảo sát người tiêu dùng và dữ liệu tài chính doanh nghiệp niêm yết.
