...
Vấn đề nội sinh tiềm năng — CSI cao có thể vừa là nguyên nhân lẫn kết quả của hiệu quả cao — được xử lý bằng phương pháp GMM hệ thống (System-GMM, Blundell & Bond, 1998). Hai biến công cụ được đề xuất: (1) biến trễ một và hai kỳ của CSI, theo lý luận rằng mức hài lòng quá khứ tương quan với CSI hiện tại nhưng không tương quan trực tiếp với phần dư hiệu quả tài chính hiện tại sau khi kiểm soát các biến cộng tuyến; (2) điểm CSI trung bình của nhóm đối thủ cùng phân khúc trong cùng năm — biến này tương quan với CSI của doanh nghiệp qua các yếu tố ngành chung nhưng không bị tác động bởi hiệu quả tài chính riêng của từng doanh nghiệp. Tính hợp lệ của biến công cụ sẽ được kiểm định bằng Hansen J-test và kiểm định Arellano-Bond AR(2) để xác nhận không có tự tương quan bậc hai trong phần dư.

**Phân tích:** PLS-SEM (SmartPLS 4) để kiểm định mô hình đo lường và mô hình cấu trúc ở cấp cá nhân; bootstrapping 5.000 lần lặp để kiểm định hiệu ứng trung gian. Phân tích đa nhóm (MGA) để kiểm định H10a và H10b. Panel Data analysis (FEM/REM/System-GMM) với dữ liệu bảng cấp thương hiệu — năm cho phần kiểm định tác động CSI đến Firm Performance.
...
Đã hoàn thành luận văn Thạc sĩ Quản trị Kinh doanh (tháng 8/2020) với đề tài: “Thúc đẩy thị phần tiêu thụ ngành hàng nước tăng lực tại công ty Coca-Cola Việt Nam”, thực hiện dưới sự hướng dẫn của TS. Phùng Minh Tuấn, Đại học Tôn Đức Thắng. Trong quá trình thực hiện, đã ứng dụng phương pháp nghiên cứu định lượng với phần mềm SPSS để phân tích hồi quy và kiểm định thang đo. Hiện đang theo học chương trình Tiến sĩ Quản trị Kinh doanh (DBA) từ tháng 9/2024, với đề tài định hướng: “Tác động của marketing xanh đến hành vi mua của người tiêu dùng”. Đang nâng cao kỹ năng phân tích PLS-SEM với SmartPLS để phục vụ nghiên cứu tiến sĩ.
...
*Hướng 3, Ứng dụng AI trong đo lường CSI và khuếch đại eWOM:* Trong giai đoạn hậu tiến sĩ, hướng nghiên cứu này tập trung vào hai cơ chế cụ thể mà AI đang tái định hình chuỗi CSI – eWOM – Firm Performance.
